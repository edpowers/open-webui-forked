...
export const getTopQuestions = async (token: string = '') => {
	let error = null;

	const res = await fetch(`${OLLAMA_API_BASE_URL}/backend/top_questions`, {
		method: 'GET',
		headers: {
	...
	console.log(res.top_questions);

	return res.top_questions;
};
