							...
							<div class="flex flex-col flex-1">
								<div class="flex border-b dark:border-gray-600 w-full">
									<input
										...
										placeholder={$i18n.t('Title (e.g. What are my rights)')}
										bind:value={prompt.title[0]}
									/>

									<input
										class="px-3 py-1.5 text-xs w-full bg-transparent outline-none border-r dark:border-gray-600"
										placeholder={$i18n.t('Subtitle (e.g. if I get arrested by the police)')}
								...
								<input
									class="px-3 py-1.5 text-xs w-full bg-transparent outline-none border-r dark:border-gray-600"
									placeholder={$i18n.t('Prompt (e.g. If I get arrested by the police, what are my constitutional rights? What should I do or not do in that situation?)')}
